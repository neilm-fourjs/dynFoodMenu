...
PUBLIC FUNCTION v1_getWards(l_token STRING ATTRIBUTE(WSParam)) ATTRIBUTES( 
		WSPath = "/v1/getWards/{l_token}",
		WSGet, 
...
PUBLIC FUNCTION v1_getPatients(l_token STRING ATTRIBUTE(WSParam), l_ward SMALLINT ATTRIBUTE(WSParam)) ATTRIBUTES( 
		WSPath = "/v1/getPatients/{l_token}/{l_ward}", 
		WSGet, 
...
#+ result: An array of wards
PUBLIC FUNCTION v2_getWards(l_token STRING ATTRIBUTE(WSParam)) ATTRIBUTES( 
		WSPath = "/v2/getWards/{l_token}",
		WSGet,
&ifdef USE_SCOPES
		WSScope = "dfm.get",
&endif
...
#+ result: A menu array by ID
PUBLIC FUNCTION v2_getPatients(l_token STRING ATTRIBUTE(WSParam), l_ward SMALLINT ATTRIBUTE(WSParam)) ATTRIBUTES( 
		WSPath = "/v2/getPatients/{l_token}/{l_ward}", 
		WSGet,
&ifdef USE_SCOPES
		WSScope = "dfm.get",
&endif
